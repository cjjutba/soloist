...
--> statement-breakpoint
ALTER TABLE "tenants" ADD COLUMN "owner_user_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "tenants" ADD COLUMN "activated_at" timestamp with time zone;--> statement-breakpoint
